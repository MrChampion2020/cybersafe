...
<div className="flex flex-col lg:flex-row gap-6 p-28 px-3 max-w-6xl mx-auto">
      ...
      <div className="flex flex-col gap-6 text-left lg:w-1/2">
        <h1 className="text-3xl font-bold lg:text-5xl">Welcome to Cyber Safe</h1>
        <p className="text-gray-500 text-xs sm:text-sm">
          Here to inform, empower and provide help to keep you safe online, at work and everywhere.
        </p>
        <Link
          to="/search"
          className="text-xs sm:text-sm text-teal-500 font-bold hover:underline"
